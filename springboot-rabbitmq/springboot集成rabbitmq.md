...
# [项目地址](https://github.com/2425358736/springboot/tree/master/springboot-rabbitmq)
### 简介
RabbitMQ是实现了高级消息队列协议（AMQP）的开源消息代理软件（亦称面向消息的中间件）。RabbitMQ服务器是用Erlang语言编写的，而群集和故障转移是构建在开放电信平台框架上的。所有主要的编程语言均有与代理接口通讯的客户端库。

### 安装请自行百度

### [docker安装rabbitmq](https://blog.csdn.net/lzq199528/article/details/90055090)
...
访问 http://localhost:6001/rabbitmq/pushQueue?queueName=queue.one&content=dddddddddddddddd


###### 像交换机推送消息

访问 http://localhost:6001/rabbitmq/pushExchange?exchangeName=exchange.one&RoutingKey=exchangeOne.queueOne&content=dddddddddddddddd 
###### 通过路由建来匹配要转发的队列，如果是广播交换机，路由则是null,会给旗下的所有队列转发消息（如请求： http://localhost:6001/rabbitmq/pushExchange?exchangeName=fanoutExchange&content=dddddddddddddddd）
